                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="contact-name">
                                                                    ...
                                                                    <input  type="text" id="c-name" class="form-control" placeholder="Tên dịch vụ">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="contact-location">
                                                                    ...
                                                                    <input  type="text" id="c-location" class="form-control" placeholder="Tên ứng dụng">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                        ...
                                        <div class="modal-footer">
                                            <button id="btn-edit" class="float-left btn">Lưu</button>

                                            <button class="btn" data-dismiss="modal"> <i class="flaticon-delete-1"></i> Hủy</button>
                        ...
                        <div class="items items-header-section">
                            <div class="item-content">
                                ...
                                <div class="user-location">
                                    <h4 style="margin-left: 0;">Tên ứng dụng</h4>
                                </div>
                            ...
                            <div class="items">
                                <div class="item-content">
                                    ...
                                    <div class="user-location">
                                        ...
                                        <p class="usr-location" data-email="<?= $user->detail ?>"><?= $user->detail ?></p>
                                    </div>
                                    <div class="action-btn">
...
<script src="/style/assets/js/apps/apps.js"></script>